        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex w-full justify-between">
              <ul className="">
                <li className="mb-4">
                  <h3 className="text-s text-slate-500 uppercase mb-2">Role</h3>
                ...
                <li className="mb-4">
                  <h3 className="text-s text-slate-500 uppercase mb-2">Team</h3>
                  <div className="flex items-center">
                    <img
              ...
              <div className="relative w-64 self-end">
                ...
                />
                <img
                  className="absolute right-44 top-40 w-40 h-40"
                  src={player.statistics[0].team.logo}
                  alt={`${player.statistics[0].team.name} logo`}
                />
              </div>
